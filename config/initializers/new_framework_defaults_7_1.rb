...
#++
Rails.application.config.action_controller.allow_deprecated_parameters_hash_equality = true
...
#++
Rails.application.config.active_support.raise_on_invalid_cache_expiration_time = false
...
#++
Rails.application.config.dom_testing_default_html_version = :html4
